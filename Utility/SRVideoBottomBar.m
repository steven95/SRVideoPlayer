...
- (UIButton *)playPauseBtn {
    ...
    if (!_playPauseBtn) {
        ...
        [_playPauseBtn setImage:image1 forState:UIControlStateNormal];
...
- (UIButton *)changeScreenBtn {
    ...
    if (!_changeScreenBtn) {
        ...
        NSBundle* bundle  =   [NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"SRVideoPlayer" ofType:@"bundle"]];
        UIImage *image1 = [UIImage imageWithContentsOfFile:[bundle pathForResource:@"full_screen@2x" ofType:@"png"]];
        [_changeScreenBtn setImage:image1 forState:UIControlStateNormal];
...
- (UISlider *)videoProgressSlider {
    ...
    if (!_videoProgressSlider) {
        ...
        NSBundle* bundle  =   [NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"SRVideoPlayer" ofType:@"bundle"]];
        UIImage *image1 = [UIImage imageWithContentsOfFile:[bundle pathForResource:@"dot@2x" ofType:@"png"]];        [_videoProgressSlider setThumbImage:image1  forState:UIControlStateNormal];
